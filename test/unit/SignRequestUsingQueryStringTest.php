...
class SignRequestUsingQueryStringTest extends TestBase
{
    ...
    public function itShouldGenerateSignedUrl()
    {
        ...
        $expires = 123456;
        $signedUrl = $client->presignUrl('http://example.com/something?foo=bar&baz=barbaz', $date, $expires);
    ...
    public function itShouldAutomagicallyAddMandatoryHeaders()
    {
        ...
        $date = new DateTime('2011/05/11 12:00:00', new DateTimeZone("UTC"));
        $expires = 123456;
        $signedUrl = $client->presignUrl('http://example.com/something?foo=bar&baz=barbaz', $date, $expires, array(), array());
